...
case1_step2={
"step1":["cat /etc/jsac/filter.json","deny-suffix"],
"step2":["cat /etc/jsac/filter.json",case1_extend1]
}
...
case2_step2={
"step1":["cat /etc/jsac/filter.json","deny-suffix"],
"step2":["cat /etc/jsac/filter.json",case2_extend1],
"step3":["cat /etc/jsac/filter.json",case2_extend2]
}
