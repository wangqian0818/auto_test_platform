...
try:
	...
	from mail_check_extend import message
...
class Test_mail_check_extend():
	...
	@allure.feature('验证基于文件扩展名过滤的邮件策略')
	...
	@allure.feature('验证基于多个文件扩展名过滤的邮件策略')
	def test_mail_check_extend_a2(self):
