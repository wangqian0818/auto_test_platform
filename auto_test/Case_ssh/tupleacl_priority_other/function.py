...
try:
	from tupleacl_priority_other import index
except Exception as err:
	print(
...
class Test_acl_priority_other():
	...
	@allure.feature('验证优先级相同情况下的策略命中规则（action不同）')
	def test_acl_priority_other_a1(self):
	...
	@allure.feature('验证优先级不同情况下的策略命中')
