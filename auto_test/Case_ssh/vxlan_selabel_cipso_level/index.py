...
pkt1_cfg={
    "send":[ciface,1,"0001_TCP_VXLAN_TCP__16_14_3.pcap"],
    "capture":[siface,f"udp and host {pcap_dip}",1,"vxlan_selabel_cipso_level_255.pcap"],
    "read":["vxlan_selabel_cipso_level_255.pcap",0],
    "expect":[strip,0,0]
}
pkt2_cfg={
    "send":[ciface,1,"0001_TCP_VXLAN_TCP__16_14_3.pcap"],
    "capture":[siface,f"udp and host {pcap_dip}",1,"vxlan_selabel_cipso_level_00.pcap"],
    "read":["vxlan_selabel_cipso_level_00.pcap",0],
    "expect":[strip,0,0]
}
#配置下发
