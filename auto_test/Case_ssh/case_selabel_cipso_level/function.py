...
try:
	from case_selabel_cipso_level import index
except Exception as err:
	print(
...
class Test_selabel_cipso_level():
	...
	@allure.feature('验证标记字段level的右边界ff')
	def test_selabel_cipso_level_255(self):
	#
	# 	# 下发配置并检查结果
	...
	#@pytest.mark.skip(reseason="skip")
	@allure.feature('验证标记字段level的左边界00')
	def test_selabel_cipso_level_00(self):
	...
	#@allure.feature('验证能否添加标记字段level的右边界ff及左边界00')
