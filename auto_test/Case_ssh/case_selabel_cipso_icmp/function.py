...
try:
	from case_selabel_cipso_icmp import index
except Exception as err:
	print(
...
class Test_selabel_cipso_icmp():
	...
	@allure.feature('验证发送icmp报文，type=8、code=0')
	...
	# @pytest.mark.skip(reseason="skip")
	@allure.feature('验证发送icmp报文，type=3、code=3')
	def test_selabel_category_cipso_icmp_type3(self):
