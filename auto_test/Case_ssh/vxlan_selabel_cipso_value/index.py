...
pkt1_cfg={
    ...
    "capture":[siface,f"udp and host {pcap_dip}",1,"vxlan_selabel_cipso_category_right.pcap"],
    "read":["vxlan_selabel_cipso_category_right.pcap",0],
    "expect":[strip,0,0]
}
pkt2_cfg={
    "send":[ciface,1,"0001_TCP_VXLAN_TCP__16_14_0.pcap"],
    "capture":[siface,f"udp and host {pcap_dip}",1,"vxlan_selabel_cipso_category_left.pcap"],
    "read":["vxlan_selabel_cipso_category_left.pcap",0],
    "expect":[strip,0,0]
}

pkt3_cfg={
    "send":[ciface,1,"0001_TCP_VXLAN_TCP__16_14_0.pcap"],
    "capture":[siface,f"udp and host {pcap_dip}",1,"vxlan_selabel_cipso_category_range_1.pcap"],
    "read":["vxlan_selabel_cipso_category_range_1.pcap",0],
...
pkt4_cfg={
    "send":[ciface,1,"0001_TCP_VXLAN_TCP__16_14_0.pcap"],
    "capture":[siface,f"udp and host {pcap_dip}",1,"vxlan_selabel_cipso_category_range_2.pcap"],
    "read":["vxlan_selabel_cipso_category_range_2.pcap",0],
...
pkt5_cfg={
    "send":[ciface,1,"0001_TCP_VXLAN_TCP__16_14_0.pcap"],
    "capture":[siface,f"udp and host {pcap_dip}",1,"vxlan_selabel_cipso_category_range_3.pcap"],
    "read":["vxlan_selabel_cipso_category_range_3.pcap",0],
...
pkt6_cfg={
    "send":[ciface,1,"0001_TCP_VXLAN_TCP__16_14_0.pcap"],
    "capture":[siface,f"udp and host {pcap_dip}",1,"vxlan_selabel_cipso_category_range_4.pcap"],
    "read":["vxlan_selabel_cipso_category_range_4.pcap",0],
...
pkt7_cfg={
    "send":[ciface,1,"0001_TCP_VXLAN_TCP__16_14_0.pcap"],
    "capture":[siface,f"udp and host {pcap_dip}",1,"vxlan_selabel_cipso_category_range_5.pcap"],
    "read":["vxlan_selabel_cipso_category_range_5.pcap",0],
...
pkt8_cfg={
    "send":[ciface,1,"0001_TCP_VXLAN_TCP__16_14_0.pcap"],
    "capture":[siface,f"udp and host {pcap_dip}",1,"vxlan_selabel_cipso_category_range_6.pcap"],
    "read":["vxlan_selabel_cipso_category_range_6.pcap",0],
