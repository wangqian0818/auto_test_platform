...
SECRET_KEY = 'i+jpm@2qk(pg3mgvm(6#9ot8-!z2v!)e7#m4idfy=d9@x%wsm0'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # 'auto_test_platform.context_processor.settings',
                # 'auto_test_platform.context_processor.ip_address',
            ],
        },
    },
]
